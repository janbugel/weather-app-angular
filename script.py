...
def process_directory(root_dir, output_file, exclude_files=['.DS_Store', '.ico']):
    """
    ...
    for root, dirs, files in os.walk(root_dir):
        ...
        for file_name in files:
            if file_name.endswith(tuple(exclude_files)):
                continue
...
if __name__ == '__main__':
    root_dir = '/Users/asdf/Documents/weather-app-angular/src/app/heat-index-calculator'  # Updated root directory
